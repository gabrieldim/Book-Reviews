        ...
        <div className="container-fluid">
            ...
            <div className="row p-3 container-lt-blue">
                <div className="col-sm-6">
                    ...
                    <p> Beyond Order is the follow-up to Jordan Peterson's bestselling book 12 Rules for Life and identifies another
                        12 rules to live by that help us live with and even embrace the chaos that we struggle with every day,
